...
import { addHotels, fetchHotels } from "../redux/actionCreators/hotels";
import { addPrices, fetchPrices } from "../redux/actionCreators/prices";
...
describe("actions", () => {
    ...
    it("should create an action to add hotels", () => {
        ...
        expect(addHotels(hotels)).toEqual(expectedAction);
    });
    ...
    it("should create an action to add prices", () => {
        ...
        expect(addPrices(prices)).toEqual(expectedAction);
    });
});
...
describe("async actions", () => {
    ...
    it("creates ADD_HOTELS when fetching hotels has been done", () => {
        ...
        return store.dispatch(fetchHotels()).then(() => {
    ...
    it("creates ADD_PRICES when fetching prices has been done", () => {
        ...
        return store.dispatch(fetchPrices(currency)).then(() => {
            // return of async actions
            expect(store.getActions()).toEqual(expectedActions);
        });
    });
